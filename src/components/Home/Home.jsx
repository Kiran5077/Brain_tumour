        ...
        <div className="w-full max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16 px-4 sm:px-6">
          ...
          <div className="w-full md:w-[40%]">
            ...
            >
              <button
                onClick={handleStartPrediction}
                className="bg-gradient-to-r from-green-500 to-blue-500 hover:from-blue-600 hover:to-blue-500 text-black text-lg font-semibold py-3 px-8 rounded-full shadow-lg transition duration-300"
              >
                Predict
              </button>
            </motion.div>
